...
func TestRun(t *testing.T) {
	...
	t.Run("if were errs in first M tasks, than finished not more N+M tasks", func(t *testing.T) {
		tasksCount := 50
	...
	t.Run("tasks without errs", func(t *testing.T) {
		tasksCount := 50
		tasks := make([]Task, 0, tasksCount)
...
func TestRunCustom(t *testing.T) {
	...
	t.Run("errs limit is zero or negative", func(t *testing.T) {
		tasks := []Task{
